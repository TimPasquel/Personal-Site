...
<body>
	...
	<h2>Welcome!</h2>	
		<img class='centerimages' border="5px" src="images/ProfHeadshot.jpeg" alt="Headshot" style='width:450px;height:500px;'>
...
assistance if needed.</td>
	...
	<h2>Tools/Skills:</h2>
		...
		<ul>
			...
			<li>Patch cable and ethernet cable splicing</li>
			<li>Small engine maintenance</li>
	...
	<h2>Organizations:</h2>
		...
		<ul>
			...
			<li>Kutztown Stem Club: 2023-Present</li>
			<li>Photographer for ReadySetDrift at Pocono Raceway: 2023-Present</li>
			<li>Kutztown University Marching Unit: 2021-2023</li>
			<li>Kutztown University Esports Team: 2021-2022</li>
		</ul>
		</div>
	</td></tr>
	</table>
